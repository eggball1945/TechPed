                    ...
                    <tr class="border-b border-slate-100 hover:bg-slate-50 transition">
                        ...
                        <td class="py-4 px-4 text-center">
                            <div class="flex justify-center">
                                <a href="{{ route('admin.complaints.show', $complaint->id) }}" class="w-[24px] h-[24px] flex items-center justify-center rounded cursor-pointer hover:bg-slate-200 text-violet-700 transition-colors duration-150" title="Detail">
