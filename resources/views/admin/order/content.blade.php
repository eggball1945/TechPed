<div class="w-[1080px] bg-white rounded-md border border-gray-300 p-4">
    <div class="w-full bg-slate-50 border border-slate-200 rounded-full p-2 flex gap-4 text-[12px] font-medium">
        ...
        <a href="{{ route('admin.order.index', ['status' => 'selesai']) }}" class="sort-btn px-3 py-2 rounded-full flex items-center gap-3 {{ request('status') === 'selesai' ? 'bg-violet-700 text-white' : 'hover:bg-gray-100 text-gray-700' }}">Selesai</a>
        <a href="{{ route('admin.order.index', ['status' => 'dibatalkan']) }}" class="sort-btn px-3 py-2 rounded-full flex items-center gap-3 {{ request('status') === 'dibatalkan' ? 'bg-violet-700 text-white' : 'hover:bg-gray-100 text-gray-700' }}">Dibatalkan</a>
    </div>
    ...
    <div class="w-full flex items-center gap-3 mb-4">
        ...
        <div class="relative mt-4">
            ...
            <ul id="filterMenu" class="absolute hidden w-full bg-white rounded shadow-md mt-1 z-50">
                <li data-value="order_id_asc" class="px-2 py-1 text-[8px] hover:bg-violet-700 hover:text-white cursor-pointer">Order ID Terkecil</li>
                <li data-value="order_id_desc" class="px-2 py-1 text-[8px] hover:bg-violet-700 hover:text-white cursor-pointer">Order ID Terbesar</li>
                ...
                <li data-value="tanggal_asc" class="px-2 py-1 text-[8px] hover:bg-violet-700 hover:text-white cursor-pointer">Tanggal Terlama</li>
                <li data-value="tanggal_desc" class="px-2 py-1 text-[8px] hover:bg-violet-700 hover:text-white cursor-pointer">Tanggal Terbaru</li>
                <li data-value="jumlah_barang_asc" class="px-2 py-1 text-[8px] hover:bg-violet-700 hover:text-white cursor-pointer">Jumlah Barang Sedikit</li>
                <li data-value="jumlah_barang_desc" class="px-2 py-1 text-[8px] hover:bg-violet-700 hover:text-white cursor-pointer">Jumlah Barang Banyak</li>
                <li data-value="total_harga_asc" class="px-2 py-1 text-[8px] hover:bg-violet-700 hover:text-white cursor-pointer">Total Harga Sedikit</li>
                <li data-value="total_harga_desc" class="px-2 py-1 text-[8px] hover:bg-violet-700 hover:text-white cursor-pointer rounded-b-md">Total Harga Banyak</li>
            </ul>
        </div>
    ...
    <div class="flex items-center justify-between mt-6 text-[10px] text-slate-600">
        ...
        <div class="flex gap-1">
            ...
            @else
                <a href="{{ $orders->previousPageUrl() }}" class="px-3 py-1 border rounded hover:bg-slate-100 cursor-pointer">
                    Sebelumnya
                </a>
            @endif

            @if ($orders->hasMorePages())
                <a href="{{ $orders->nextPageUrl() }}" class="px-3 py-1 border rounded hover:bg-slate-100 cursor-pointer">
                    Selanjutnya
                </a>
            @else
