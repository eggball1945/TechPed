<div class="flex justify-center items-start gap-12">
    <div class="flex flex-col items-center gap-3 max-w-[220px] text-center">
        <div class="w-16 h-16 flex items-center justify-center rounded-full bg-gray-200">
            <div class="w-12 h-12 flex items-center justify-center rounded-full bg-black">
                <svg class="size-8" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_2513_7701)">
                        <path d="M11.6663 31.6667C13.5073 31.6667 14.9997 30.1743 14.9997 28.3333C14.9997 26.4924 13.5073 25 11.6663 25C9.82539 25 8.33301 26.4924 8.33301 28.3333C8.33301 30.1743 9.82539 31.6667 11.6663 31.6667Z" stroke="#FAFAFA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <path d="M5 11.8181H11.6667" stroke="#FAFAFA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M1.81836 15.4546H8.48503" stroke="#FAFAFA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M5 19.0908H11.6667" stroke="#FAFAFA" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </g>
                    <defs>
                        <clipPath id="clip0_2513_7701">
        ...
        <div class="flex flex-col gap-1">
            <span class="font-semibold text-sm whitespace-nowrap">
                PENGIRIMAN GRATIS & CEPAT
            </span>
            <span class="text-xs opacity-80 whitespace-nowrap">
                Gratis ongkir min. Rp 5.000.000
            </span>
        </div>
    </div>
    ...
    <div class="flex flex-col items-center gap-3 max-w-[220px] text-center">
        <div class="w-16 h-16 flex items-center justify-center rounded-full bg-gray-200">
            <div class="w-12 h-12 flex items-center justify-center rounded-full bg-black">
                <svg class="size-8" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_2497_1833)">
