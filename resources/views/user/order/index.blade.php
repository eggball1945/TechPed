                            ...
                            <div class="flex flex-wrap items-center gap-3">
                                ...
                                <div class="flex items-center gap-2 ml-2">
                                    ...
                                    @if($order->status === 'dikirim' || $order->status === 'selesai')
                                        <a href="{{ route('complaints.create', $order->id) }}" class="px-5 py-2.5 bg-violet-50 hover:bg-violet-100 text-violet-700 text-xs font-black rounded-xl transition-all uppercase cursor-pointer flex items-center gap-2">
