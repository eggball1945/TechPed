<div class="w-[1080px] bg-white rounded-md border border-gray-300 p-4">
    <div class="w-full bg-slate-50 border border-slate-200 rounded-full p-2 flex gap-4 text-[12px] font-medium">
        <a href="{{ route('petugas.order.index') }}" class="sort-btn px-3 py-2 rounded-full flex items-center gap-3 {{ request('status') === null ? 'bg-violet-700 text-white' : 'hover:bg-gray-100 text-gray-700' }}">Semua Order</a>
    ...
    <form method="GET" action="{{ route('petugas.order.index') }}" class="w-full flex items-center gap-3 mb-4">
...
<div id="cardDetailOrder" class="hidden fixed inset-0 bg-black/40 items-center justify-center z-50">
    <div class="w-[392px] max-h-[90vh] bg-white rounded-lg shadow-lg p-4 overflow-y-auto overflow-x-hidden relative">
        ...
        <div id="order_proof_container" class="hidden flex-col justify-between mt-3">
            <span class="font-medium text-[12px] leading-[24px] text-left text-black block mb-2">
                Bukti Pembayaran
            </span>
