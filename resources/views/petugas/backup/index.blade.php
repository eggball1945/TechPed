...
<div class="max-w-7xl mx-auto px-6 py-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl p-6 border border-gray-300 shadow-sm flex flex-col justify-between">
            ...
            <a href="{{ route('petugas.backup.download') }}" class="w-full py-2 bg-violet-700 text-white rounded text-[12px] font-medium text-center hover:bg-violet-800 transition-colors">
                Unduh Backup (.sql)
            </a>
        </div>
        ...
        <div class="bg-white rounded-xl p-6 border border-gray-300 shadow-sm">
            ...
            <form action="{{ route('petugas.backup.restore') }}" method="POST" enctype="multipart/form-data" id="restoreForm">
                @csrf
                <div class="mb-4">
