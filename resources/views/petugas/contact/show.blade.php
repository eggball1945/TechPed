...
<div class="p-6">
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('petugas.contact.index') }}" class="h-8 px-4 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded flex items-center gap-2 text-[11px] font-medium transition cursor-pointer">
