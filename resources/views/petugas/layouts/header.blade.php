<div class="w-full h-14 bg-white flex items-center px-6 border-b border-gray-300/70">
    <div class="flex items-center gap-4 ml-auto">
        {{-- Profile (SVG & Username only) --}}
        <div class="flex items-center gap-2">
            ...
            <span class="text-[10px] font-medium text-black">
                {{ Auth::guard('petugas')->user() ? Auth::guard('petugas')->user()->username : '-' }}
            </span>
        </div>  
    </div>
</div>