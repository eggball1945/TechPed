...
<div class="w-[1080px] bg-white rounded-lg border border-gray-300 p-4 mt-8">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('petugas.laporan.excel', ['tahun' => $tahun, 'user_id' => $user_id]) }}" class="px-3 py-1 text-xs bg-violet-700 text-white rounded">Excel</a>
            <a href="{{ route('petugas.laporan.pdf', ['tahun' => $tahun, 'user_id' => $user_id]) }}" class="px-3 py-1 text-xs bg-violet-700 text-white rounded">PDF</a>
        </div>
    </div>
