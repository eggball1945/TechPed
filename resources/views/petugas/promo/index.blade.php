                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-right">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <form action="{{ route('petugas.promo.destroy', $promo->id) }}" method="POST" onsubmit="return confirm('Hapus promo ini?')">
                                @csrf
                                @method('DELETE')
...
<div id="modalTambahPromo" class="hidden fixed flex inset-0 bg-black/40 items-center justify-center z-50">
    <div class="w-[392px] bg-white rounded-lg shadow-lg p-5 relative">
        ...
        <form id="formPromo" method="POST" action="{{ route('petugas.promo.store') }}">
            @csrf
...
<script>
    function closeModal() {
        ...
        document.getElementById('formPromo').action = "{{ route('petugas.promo.store') }}";
    ...
    function editPromo(id, name, endDate) {
        ...
        document.getElementById('formPromo').action = "/petugas/promo/" + id;
